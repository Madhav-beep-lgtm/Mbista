...
CREATE TABLE IF NOT EXISTS `ledger_groups` (
  ...
  `party_role` VARCHAR(40) DEFAULT NULL,
  ...
  UNIQUE KEY `uniq_ledger_groups_company_party_role` (`company_id`, `party_role`),
...
CREATE TABLE IF NOT EXISTS `vouchers` (
  ...
  `instrument_no` VARCHAR(80) DEFAULT NULL,
  ...
  KEY `idx_vouchers_type_date` (`company_id`, `voucher_type`, `voucher_date`),
...
CREATE TABLE IF NOT EXISTS `leave_types` (
  ...
  `deduct_salary` TINYINT(1) NOT NULL DEFAULT 0,
  `is_system` TINYINT(1) NOT NULL DEFAULT 0,
  `is_active` TINYINT(1) NOT NULL DEFAULT 1,
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `accounting_parties` (
  ...
  `supplier_advance_ledger_id` INT UNSIGNED DEFAULT NULL,
  ...
  KEY `idx_parties_supplier_advance_ledger` (`supplier_advance_ledger_id`),
...
CREATE TABLE IF NOT EXISTS `payroll_settings` (
  ...
  `sst_payable_ledger_id` INT UNSIGNED DEFAULT NULL,
  ...
  `standard_working_days` DECIMAL(5,2) NOT NULL DEFAULT 30.00,
  `deduct_unpaid_leave` TINYINT(1) NOT NULL DEFAULT 1,
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `payroll_runs` (
  ...
  `voucher_date` DATE DEFAULT NULL,
  `employee_scope` TEXT DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `payroll_run_lines` (
  ...
  `sst_month` DECIMAL(14,2) NOT NULL DEFAULT 0,
  ...
  `unpaid_leave_deduction` DECIMAL(14,2) NOT NULL DEFAULT 0.00,
  `adj_earning` DECIMAL(14,2) NOT NULL DEFAULT 0.00,
  `adj_deduction` DECIMAL(14,2) NOT NULL DEFAULT 0.00,
  `adj_remark` VARCHAR(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `inventory_transactions` (
  ...
  `jewellery_stock_txn_id` INT UNSIGNED DEFAULT NULL,
  ...
  UNIQUE KEY `uniq_inventory_jewellery_stock_txn` (`jewellery_stock_txn_id`),
...
CREATE TABLE IF NOT EXISTS `inventory_nrv_assessments` (
  ...
  KEY `idx_inv_nrv_source_txn` (`source_txn_id`),
  KEY `idx_inv_nrv_item_status` (`company_id`, `item_id`, `status`),
...
-- ============================================================================
-- Opening-balance management layer (migration 053) — formal batch/line/audit
-- record over the perpetual GL. See app/opening_balance_engine.php.
-- ============================================================================
...
-- Online payment gateways (migration 054)
