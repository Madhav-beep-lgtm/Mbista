                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="post" style="display:inline" data-confirm="Remove this salary revision?">
                                        ...
                                        <input type="hidden" name="employee_id" value="<?= e((int) $editEmployee['id']) ?>">
                                        <button type="submit" class="button secondary danger-text" aria-label="Delete this salary revision" title="Delete this salary revision"><?= icon('trash') ?></button>
                                    </form>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                            ...
                            <tr>
                                ...
                                <td style="white-space:nowrap">
                                    ...
                                    <form method="post" style="display:inline" data-confirm="Remove this projection?">
                                        ...
                                        <input type="hidden" name="projection_id" value="<?= e((int) $projection['id']) ?>">
                                        <input type="hidden" name="employee_id" value="<?= e((int) $editEmployee['id']) ?>">
                                        <button type="submit" class="button secondary danger-text" aria-label="Delete this projection" title="Delete this projection"><?= icon('trash') ?></button>
                                    </form>
                                </td>
                            </tr>
                        <?php endforeach; ?>
