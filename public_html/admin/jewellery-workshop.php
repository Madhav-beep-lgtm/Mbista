...
<?php if ($view === 'orders'): ?>
    ...
    <section class="mbw-card" data-collapsible style="margin-top:14px">
        ...
        <form method="get" style="margin-bottom:8px;display:flex;gap:10px;flex-wrap:nowrap;align-items:end;overflow-x:auto;padding:2px 0 8px">
            ...
            <label style="display:grid;gap:4px;flex:1 0 230px;margin:0"><span style="font-size:12.5px">Date range</span><button type="button" class="field-compact" id="jw-orders-date-range-open" style="text-align:left;white-space:nowrap;background:var(--mbw-card,#fff)!important;color:var(--mbw-ink,#12261f)!important;border:1px solid var(--mbw-border,#cfe0d7)!important" aria-haspopup="dialog"><span id="jw-orders-date-range-label"><?= e($filterFrom !== '' || $filterTo !== '' ? ($filterFrom !== '' ? app_date($filterFrom) : 'Start') . ' – ' . ($filterTo !== '' ? app_date($filterTo) : 'End') : 'Select range') ?></span></button></label>
        ...
        (function () {
            ...
            apply.addEventListener('click', function () {
                ...
                label.textContent = from.value || to.value ? (from.value || 'Start') + ' – ' + (to.value || 'End') : 'Select range';
                dialog.close();
            });
