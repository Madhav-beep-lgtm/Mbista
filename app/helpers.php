...
function icon(string $name): string
{
    $icons = [
        ...
        'aml' => [
            'viewBox' => '0 0 24 24',
            'paths' => ['M12 3l7 3v5c0 4.6-2.8 8.1-7 10-4.2-1.9-7-5.4-7-10V6z', 'M9 11l2 2 4-4'],
        ],
        'messages' => [
            'viewBox' => '0 0 24 24',
        ...
        'sun' => [
            'viewBox' => '0 0 24 24',
            'paths' => ['M12 2v2', 'M12 20v2', 'M4.93 4.93l1.42 1.42', 'M17.66 17.66l1.41 1.41', 'M2 12h2', 'M20 12h2', 'M4.93 19.07l1.42-1.42', 'M17.66 6.34l1.41-1.41', 'M16 12a4 4 0 1 1-8 0 4 4 0 0 1 8 0'],
        ],
        'profile' => [
            'viewBox' => '0 0 24 24',
            'paths' => ['M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2', 'M12 11a4 4 0 1 0 0-8'],
        ...
        'edit' => [
            'viewBox' => '0 0 24 24',
            'paths' => ['M12 20h9', 'M16.5 3.5a2.12 2.12 0 0 1 3 3L8 18l-4 1 1-4z'],
        ],
        'trash' => [
            'viewBox' => '0 0 24 24',
            'paths' => ['M3 6h18', 'M8 6V4h8v2', 'M6 6l1 15h10l1-15', 'M10 10v7', 'M14 10v7'],
        ],
        'phone' => [
            'viewBox' => '0 0 24 24',
        ...
        'language' => [
            'viewBox' => '0 0 24 24',
            'paths' => ['M4 5h10', 'M9 3v2', 'M6 9c1.5 2.5 3.5 4.5 6 6', 'M12 9c-1.5 2.5-3.5 4.5-6 6', 'M14 19l3.5-9 3.5 9', 'M15.5 16h4'],
        ],
        'globe-language' => [
            'viewBox' => '0 0 24 24',
            'paths' => ['M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20', 'M2 12h20', 'M12 2a15.3 15.3 0 0 1 0 20', 'M12 2a15.3 15.3 0 0 0 0 20'],
        ],
        'calendar-range' => [
            'viewBox' => '0 0 24 24',
            'paths' => ['M8 2v4', 'M16 2v4', 'M3 10h18', 'M5 4h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2', 'M7 14h3', 'M14 14h3', 'M7 18h3'],
        ],
        'bank' => [
            'viewBox' => '0 0 24 24',
