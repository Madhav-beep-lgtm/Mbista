    ...
    <div class="rpt-foot">
        ...
        <?php if (!empty($meta['pdf_url'])): ?>
            <span class="rpt-foot-actions">
                <a href="<?= e((string) $meta['pdf_url']) ?>" target="_blank" aria-label="Export PDF" title="Export PDF"><?= icon('documents') ?></a>
                <a href="<?= e((string) $meta['excel_url']) ?>" aria-label="Export Excel" title="Export Excel"><?= icon('analytics') ?></a>
